<template>
  <div>
    ...
    <b-table
      ...
      <b-table-column label="Họ và tên" field="name" sortable v-slot="props">
        {{ props.row.name }}
      </b-table-column>
       <b-table-column label="Email" field="name" sortable v-slot="props">
        {{ props.row.name }}
      </b-table-column>
      <b-table-column label="Địa chỉ" field="city" sortable v-slot="props">
        {{ props.row.city }}
      </b-table-column>
     
      <b-table-column label="Ngày lập" v-slot="props">

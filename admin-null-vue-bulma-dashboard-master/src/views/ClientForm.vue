      ...
      <tiles>
        <card-component :title="formCardTitle" icon="account-edit" class="tile is-child">
          <form @submit.prevent="submit">
            ...
            <hr>
            <b-field label="Ảnh đại diện" horizontal>
              <file-picker/>
            </b-field>
            <hr>
            <b-field label="Họ và tên" message="Client name" horizontal>
              <b-input placeholder="e.g. John Doe" v-model="form.name" required />
            </b-field>
            <b-field label="Email" message="Client's company name" horizontal>
              <b-input placeholder="e.g. Berton & Steinway" v-model="form.company" required />
            </b-field>
            <b-field label="Địa chỉ" message="Client's city" horizontal>
              <b-input placeholder="e.g. Geoffreyton" v-model="form.city" required />
            </b-field>
            <b-field label="Ngày lập" horizontal>
              <b-datepicker
                @input="input"
            ...
            <hr>
            <b-field horizontal>
              <b-button type="is-primary" :loading="isLoading" native-type="submit">Lưu</b-button>
            </b-field>
          </form>
        </card-component>
        <card-component v-if="isProfileExists" title="Hồ sơ người dùng" icon="account" class="tile is-child">
